...
5. the Grand Unification of Behavior: co-location of model and view; and
...
1. DOM efficiency without VDOM cost and complexity . 
...
1. the mxWeb approach to Web Components . 
